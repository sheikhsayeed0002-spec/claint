-- =============================================================================
-- VIDEO_UPLOAD_FIX.sql
-- Run once in Supabase Dashboard → SQL Editor (or via CLI).
-- Adds a public bucket for admin-uploaded video files (MP4 / WebM).
-- Thumbnails stay in the existing `videos` image bucket.
-- Safe to re-run.
-- =============================================================================
